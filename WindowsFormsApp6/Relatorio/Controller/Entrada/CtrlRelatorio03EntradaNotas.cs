...
namespace Relatorios.Controller.Cadastros
{
    public class CtrlRelatorio03EntradaNotas : IDisposable
    {
        ...
        Relatorio03NotasDeEntrada Relatorio = new Relatorio03NotasDeEntrada(ERelatorio.NotaEntadaPeriodo03);
        ...
        private void MontaRelatorio()
        {
            this.Lista =
                ...
                lista
                .GroupBy(x => new { x.Id, x.Fornecedor, x.DescricaoNota, x.Data, x.ValorLiquidoTotal }).Select(agrupado => new AgrupadorRelatorio03()
                {
                    Id = agrupado.Key.Id,
