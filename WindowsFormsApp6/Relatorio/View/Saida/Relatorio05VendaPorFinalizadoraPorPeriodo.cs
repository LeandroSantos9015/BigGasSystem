...
namespace Relatorios.View.Cadastros.Entrada
{
    ...
    public partial class Relatorio05VendaPorFinalizadoraPorPeriodo : RelatorioBase
    {
        public Relatorio05VendaPorFinalizadoraPorPeriodo(ERelatorio relatorio, string nomeTotal, string total) : base(relatorio, nomeTotal, total)
        {
            InitializeComponent();
        }
